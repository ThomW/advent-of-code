...
for v in values:
  ...
  # Parse the string - split into segments
  parts = v.split(' ')

  # Parse min/max counts and convert them to integer
  ...
  # Count the number of occurances of the target letter in the password
  occurances = password.count(letter)

  # Print as sanity check
  print('{} {} {}-{} : {}'.format(password, letter, min, max, occurances))
  ...
  # Only one of the positions can have the target letter at any given time
...
# Print result
print('Part 1: {}'.format(part_one_result))  
print('Part 2: {}'.format(part_two_result))  
